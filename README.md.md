...
My game manages to transport you into a medieval world packed with game mechanics. =THe combat is basic yet fluid, the movement is diverse and unique, featuring multiple ways to traverse the map, and being a platformer style of game, this movement helps the game stay fun whilst staying true to the platofrmer genre. Ive achieved my goal to make a working game with features im happy with in the two term span we had to work on it.
...
| In a dark forest | A dark forest where you are a medieval knight killing futuristic eneimes |
| Target Platform |Anyone who enjoys platform stories with chilling vibes and a more dark medieval theme |
...
https://www.youtube.com/watch?v=eavdotMRA5s
...
### 3.4 Game Loop
| level 1,2 | Killing enemies |
| Start / Initialisation |when spawn in |
| Core Loop |killing enemies whilst trying not to die and keeping in mind your health bar state |
| Win / End State |when all enemies are defeated on level 1 and 2 |
| Restart |when you die you respawn |
...
`![Level Name](./Parallax_png.png)`

### 4.1 Particle Effects
|Trail Renderer|The trial behind player when dash|


> Add screenshot images using: `![Effect Name](./Particle_png.png)`
...
> `![Level Name](./Level1_png.png)`
  `![Level Name](./Level2_png.png)`
